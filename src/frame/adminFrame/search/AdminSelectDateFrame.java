...
/**
 * @author hjx
 *管理员查询用户交易明细之时间选择和交易明细显示界面
 */
public class AdminSelectDateFrame implements ActionListener, FrameInterface { 
	...
	String account;
	public AdminSelectDateFrame(String text) {
		account = text;
	}
	...
	public void show() {
        ...
        calendar.add(Calendar.MONTH, -1);//时间-一个月
	...
	public void actionPerformed(ActionEvent e) {
		...
		{//确认按钮
			...
			//查询到交易记录
			String[][] list = check.detailedInquiry(account,startText.getText(),endText.getText());
